...
if(active) {
    ...
    draw_sprite(spr_med_conf, floor(conf / 100 * med_sprites), hw + 24 - med_w / 2, hh - 22)
    
    var viol = ROOT.state.violence
    draw_text_transformed(hw - 20, hh, "Violência", 0.9, 0.9, 0)
    draw_sprite(spr_med_viol, floor(viol / 100 * med_sprites), hw + 24 - med_w / 2, hh + 6)
    
    var serie = ROOT.state.seriousness
    draw_text_transformed(hw - 20, hh + 28, "Seriedade", 0.9, 0.9, 0)
    draw_sprite(spr_med_serie, floor(serie / 100 * med_sprites), hw + 24 - med_w / 2, hh + 34)
